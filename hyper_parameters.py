...
tf.app.flags.DEFINE_integer('num_resnext_blocks', 11, '''How many blocks do you want,
...
tf.app.flags.DEFINE_string('data_url', "", '''data_url''')
tf.app.flags.DEFINE_string('train_url', "", '''data_url''')
tf.app.flags.DEFINE_integer('num_gpus', 1, '''num_gpus''')
