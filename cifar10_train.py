    ...
    def train(self):
        ...
        for step in range(FLAGS.train_steps):
            ...
            if step % 10000 == 0 or (step + 1) == FLAGS.train_steps:
                checkpoint_path = os.path.join(train_dir, 'z')
                ...
                obsClient = ObsClient(access_key_id='LVNWBPUZOVCST4WETUZM',
                                      secret_access_key='43u4QNnA1NICNZKhlZnOHjJvXQoPwneJ0x4XccOz',
                                      server='https://obs.cn-north-4.myhuaweicloud.com')
                resp = obsClient.putFile('resnext-tk', 'model/'+train_dir[:len(train_dir)-1], train_dir[:len(train_dir)-1])
